...
public class LongTxsListInput extends DataObject {
	private static final String DTO_LOGICAL_NAME = "LongTxsListInput";
	...
	public Object clone() {
		LongTxsListInput copyObj = new LongTxsListInput();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _longTxsListInput) {
		if(this == _longTxsListInput) return;
		LongTxsListInput __longTxsListInput = (LongTxsListInput) _longTxsListInput;
		
		this.setTopIds(__longTxsListInput.getTopIds());
	...
	public boolean equals(LongTxsListInput obj) {
