...
public class SyncTablesListInput extends DataObject {
	private static final String DTO_LOGICAL_NAME = "SyncTablesListInput";
	...
	private boolean tableRowCount_invalidation = false;
	
	public void setInvalidationTableRowCount(boolean invalidation) { 
		this.tableRowCount_invalidation = invalidation;
	}
	
	public boolean isInvalidationTableRowCount() {
		return this.tableRowCount_invalidation;
	}
	
	private boolean tableRowCount_modified = false;
	

	public boolean isModifiedTableRowCount() {
		return this.tableRowCount_modified;
	}
	
	public void unModifiedTableRowCount() {
		this.tableRowCount_modified = false;
	}
	...
	public void setTableRowCount(int tableRowCount) {
		...
		this.tableRowCount_modified = true;
		this.isModified = true;
	}
	...
	public void setTableRowCount(Integer tableRowCount) {
		if( tableRowCount == null) {
			...
			this.tableRowCount = tableRowCount.intValue();
		}
		this.tableRowCount_modified = true;
		this.isModified = true;
	}
	public void setTableRowCount(String tableRowCount) {
		if  (tableRowCount==null || tableRowCount.length() == 0) {
			this.tableRowCount = 0;
		} else {
			this.tableRowCount = Integer.parseInt(tableRowCount);
		}
		this.tableRowCount_modified = true;
		this.isModified = true;
	}		
	...
	private boolean pageNum_invalidation = false;
	
	public void setInvalidationPageNum(boolean invalidation) { 
		this.pageNum_invalidation = invalidation;
	}
	
	public boolean isInvalidationPageNum() {
		return this.pageNum_invalidation;
	}
	
	private boolean pageNum_modified = false;
	

	public boolean isModifiedPageNum() {
		return this.pageNum_modified;
	}
	
	public void unModifiedPageNum() {
		this.pageNum_modified = false;
	}
	...
	public List<String> getIsModifiedField() {
		...
		if(this.tableRowCount_modified == true)
			modifiedFields.add("tableRowCount");
		if(this.pageNum_modified == true)
			modifiedFields.add("pageNum");
	...
	public Object clone() {
		SyncTablesListInput copyObj = new SyncTablesListInput();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _syncTablesListInput) {
		if(this == _syncTablesListInput) return;
		SyncTablesListInput __syncTablesListInput = (SyncTablesListInput) _syncTablesListInput;
		
		this.setTopId(__syncTablesListInput.getTopId());
		this.setTableRowCount(__syncTablesListInput.getTableRowCount());
		this.setPageNum(__syncTablesListInput.getPageNum());
		this.setTargetDBName(__syncTablesListInput.getTargetDBName());
	...
	public String toString() {
		...
		buffer.append("tableRowCount : ").append(tableRowCount).append("\n");				
		buffer.append("pageNum : ").append(pageNum).append("\n");				
	...
	static {
		...
		fieldPropertyMap.put("tableRowCount"
							, FieldPropertyFactory.getFieldProperty( "tableRowCount","", "", "", false, false, false,  FieldProperty.TYPE_PRIMITIVE_INT, 5 , -1, null, null));		
		fieldPropertyMap.put("pageNum"
							, FieldPropertyFactory.getFieldProperty( "pageNum","", "", "", false, false, false,  FieldProperty.TYPE_PRIMITIVE_INT, 5 , -1, null, null));		
	...
	public Object get(String fieldName) throws FieldNotFoundException {
		switch(fieldName) {
			...
			case "tableRowCount" : return getTableRowCount();
			case "pageNum" : return getPageNum();
	...
	public void set(String fieldName, Object arg) throws FieldNotFoundException {
		switch(fieldName) {
			...
			case "tableRowCount" : setTableRowCount((Integer)arg);break;
			case "pageNum" : setPageNum((Integer)arg);break;
	...
	public boolean equals(SyncTablesListInput obj) {
		if (obj == this) return true;					
		if(this.topId != null ? !this.topId.equals(obj.getTopId()) : obj.getTopId() != null) return false; 									
		if(this.tableRowCount != obj.getTableRowCount()) return false; 								
		if(this.pageNum != obj.getPageNum()) return false; 									
