...
public class ParametersEditInput extends DataObject {
	private static final String DTO_LOGICAL_NAME = "parametersEditInput";
	...
	public ParametersEditInput fillKeyValue(int _index) {
	...
	public Object clone() {
		ParametersEditInput copyObj = new ParametersEditInput();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _parametersEditInput) {
		if(this == _parametersEditInput) return;
		ParametersEditInput __parametersEditInput = (ParametersEditInput) _parametersEditInput;
		
		this.setTopId(__parametersEditInput.getTopId());
		this.setProcessType(__parametersEditInput.getProcessType());
		this.setProcessNum(__parametersEditInput.getProcessNum());
		this.setType(__parametersEditInput.getType());
		this.clearKeyValue();
		for (int index = 0; index < __parametersEditInput.sizeKeyValue(); index++) {
			this.addKeyValue(index, (com.tmax.prosync.dto.KeyValue)__parametersEditInput.getKeyValue(index).clone());		
		}
	...
	public boolean equals(ParametersEditInput obj) {
