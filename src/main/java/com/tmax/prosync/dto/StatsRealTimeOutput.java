...
public class StatsRealTimeOutput extends DataObject {
	private static final String DTO_LOGICAL_NAME = "StatsRealTimeOutput";
	...
	public StatsRealTimeOutput fillStat(int _index) {
	...
	public Object clone() {
		StatsRealTimeOutput copyObj = new StatsRealTimeOutput();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _statsRealTimeOutput) {
		if(this == _statsRealTimeOutput) return;
		StatsRealTimeOutput __statsRealTimeOutput = (StatsRealTimeOutput) _statsRealTimeOutput;
		
		this.clearStat();
		for (int index = 0; index < __statsRealTimeOutput.sizeStat(); index++) {
			this.addStat(index, (com.tmax.prosync.dto.Stat)__statsRealTimeOutput.getStat(index).clone());		
		}
	...
	public boolean equals(StatsRealTimeOutput obj) {
