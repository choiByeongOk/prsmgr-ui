...
public class DbsListInput extends DataObject {
	private static final String DTO_LOGICAL_NAME = "DbsListInput";
	...
	public Object clone() {
		DbsListInput copyObj = new DbsListInput();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _dbsListInput) {
		if(this == _dbsListInput) return;
		DbsListInput __dbsListInput = (DbsListInput) _dbsListInput;
		
		this.setTopId(__dbsListInput.getTopId());
	...
	public boolean equals(DbsListInput obj) {
