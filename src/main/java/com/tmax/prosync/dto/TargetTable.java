...
public class TargetTable extends DataObject {
	private static final String DTO_LOGICAL_NAME = "targetTable";
	...
	public Object clone() {
		TargetTable copyObj = new TargetTable();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _targetTable) {
		if(this == _targetTable) return;
		TargetTable __targetTable = (TargetTable) _targetTable;
		
		this.setTopId(__targetTable.getTopId());
		this.setXId(__targetTable.getXId());
		this.setTsn(__targetTable.getTsn());
		this.setDdSeqNum(__targetTable.getDdSeqNum());
		this.setUserId(__targetTable.getUserId());
		this.setTableName(__targetTable.getTableName());
		this.setInstanceId(__targetTable.getInstanceId());
	...
	public boolean equals(TargetTable obj) {
