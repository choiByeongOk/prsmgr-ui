...
public class GroupsListInput extends DataObject {
	private static final String DTO_LOGICAL_NAME = "GoupsListInput";
	...
	public Object clone() {
		GroupsListInput copyObj = new GroupsListInput();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _groupsListInput) {
		if(this == _groupsListInput) return;
		GroupsListInput __groupsListInput = (GroupsListInput) _groupsListInput;
		
		this.setTopId(__groupsListInput.getTopId());
		this.setTargetDBName(__groupsListInput.getTargetDBName());
	...
	public boolean equals(GroupsListInput obj) {
