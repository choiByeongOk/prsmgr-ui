...
public class VerifyDetailInput extends DataObject {
	private static final String DTO_LOGICAL_NAME = "VerifyDetailInput";
	...
	public Object clone() {
		VerifyDetailInput copyObj = new VerifyDetailInput();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _verifyDetailInput) {
		if(this == _verifyDetailInput) return;
		VerifyDetailInput __verifyDetailInput = (VerifyDetailInput) _verifyDetailInput;
		
		this.setJobName(__verifyDetailInput.getJobName());
		this.setTopId(__verifyDetailInput.getTopId());
	...
	public boolean equals(VerifyDetailInput obj) {
