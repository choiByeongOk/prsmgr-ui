...
public class ConnectionsCheckInput extends DataObject {
	private static final String DTO_LOGICAL_NAME = "ConnectionsCreateInput";
	...
	public ConnectionsCheckInput fillConnection(int _index) {
	...
	public Object clone() {
		ConnectionsCheckInput copyObj = new ConnectionsCheckInput();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _connectionsCreateInput) {
		if(this == _connectionsCreateInput) return;
		ConnectionsCheckInput __connectionsCreateInput = (ConnectionsCheckInput) _connectionsCreateInput;
		
		this.clearConnection();
		for (int index = 0; index < __connectionsCreateInput.sizeConnection(); index++) {
			this.addConnection(index, (com.tmax.prosync.dto.Connection)__connectionsCreateInput.getConnection(index).clone());		
		}
	...
	public boolean equals(ConnectionsCheckInput obj) {
