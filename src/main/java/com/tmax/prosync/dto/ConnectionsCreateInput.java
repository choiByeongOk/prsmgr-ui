...
public class ConnectionsCreateInput extends DataObject {
	...
	public Object clone() {
		ConnectionsCreateInput copyObj = new ConnectionsCreateInput();	
		copyObj.clone(this);
		return copyObj;
	}
	public void clone(DataObject _connectionsCreateInput) {
		if(this == _connectionsCreateInput) return;
		ConnectionsCreateInput __connectionsCreateInput = (ConnectionsCreateInput) _connectionsCreateInput;
		
		this.setTopIds(__connectionsCreateInput.getTopIds());
	...
	public boolean equals(ConnectionsCreateInput obj) {
